class RecipesController < ApplicationController
  ...
  private
    ...
    def recipe_params
      params.require(:recipe).permit(:ingredient1, :ingredient2, :ingredient3, :ingredient4, :ingredient5, :ingredient6, :ingredient7, :ingredient8, :ingredient9, :ingredient10)
    end
end
